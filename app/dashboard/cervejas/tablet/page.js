        ...
        <div style={{padding:24,display:"flex",flexDirection:"column",gap:18}}>
          ...
          <div>
            ...
            <div style={{display:"flex",alignItems:"center",gap:12}}>
              ...
              <input type="number" value={qtd} min="1" step="1" onChange={e=>setQtd(e.target.value)} style={{flex:1,height:52,textAlign:"center",borderRadius:12,background:"#0F172A",border:"1.5px solid #334155",color:"#F1F5F9",fontSize:22,fontWeight:700,outline:"none"}}/>
