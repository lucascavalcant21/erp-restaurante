...
declare
  ...
  v_unidades text[];
  v_escrita text;
  v_tabs constant text[] := array['acessos_modulo', 'advertencias', 'avaliacoes_nps', 'avisos', 'campanhas', 'candidatos', 'cardapio', 'cervejas', 'checklists_execucoes', 'checklists_templates', 'clientes', 'colaboradores', 'comandas', 'config_sistema', 'contas_pagar', 'controle_gas', 'controle_limpeza', 'controle_manutencoes', 'controle_oleo', 'cupons', 'cursos', 'delivery_configs', 'documentos_rh', 'empresa_documentos', 'equipe_unidade', 'escalas_dia', 'estoque', 'estoque_atual', 'estoque_itens', 'estoque_movimentacoes', 'estoque_movimentacoes_multi', 'estoque_movimentos', 'estoques', 'etiquetas', 'evento_compras', 'evento_custos_fixos', 'evento_drinks', 'evento_ingredientes', 'evento_pratos', 'evento_preparos', 'evento_reservas', 'eventos', 'extras_cadastros', 'ficha_itens', 'fichas_alergenicos', 'fichas_armazenamento', 'fichas_custo_historico', 'fichas_equipamentos', 'fichas_etapas', 'fichas_ingredientes', 'fichas_lote_auditoria', 'fichas_montagem_passos', 'fichas_tecnicas', 'fichas_versoes', 'fornecedores', 'func_documentos', 'funcionarios', 'gastos_administrativos', 'guias_operacionais', 'hefisto_auditoria', 'holerites', 'insumos', 'insumos_fornecedores', 'insumos_precos_fornecedores', 'insumos_precos_historico', 'inventario_itens', 'inventario_movimentos', 'lancamentos', 'listas_etiquetas', 'manutencao_servicos', 'memorandos_operacao', 'mesas', 'montagem', 'motoboys', 'notas_fiscais', 'observacoes_padrao', 'op_acoes_corretivas', 'op_agendas', 'op_alertas', 'op_auditoria', 'op_evidencias', 'op_execucoes', 'op_itens', 'op_nao_conformidades', 'op_processos', 'op_respostas', 'op_secoes', 'operacao_embalagens', 'operacao_embalagens_consumo', 'orcamentos_eventos', 'pdv_caixas', 'pdv_movimentacoes', 'pedidos', 'pedidos_itens', 'ponto_marcacao', 'producao_diaria', 'producoes', 'produtos', 'registro_ponto', 'rh_advertencias_colab', 'rh_atas', 'rh_atas_reuniao', 'rh_atestados', 'rh_banco_horas', 'rh_bonificacoes', 'rh_cargos', 'rh_consumo_funcionarios', 'rh_espelho_fechado', 'rh_feriados', 'rh_folgas_esporadicas', 'rh_historico', 'rh_historico_promocoes', 'rh_ponto_liberado', 'rh_recibos_prestacao', 'rh_regulamentos', 'rh_reunioes_colab', 'rh_tipos_bonificacao', 'rh_treinamentos_colab', 'suprimentos_catalogo', 'suprimentos_historico', 'suprimentos_unidades', 'tarefas_instancias', 'tarefas_templates', 'treinamentos', 'unidades', 'venda_itens', 'vendas'];
