         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
               ...
               <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm mb-6">
                  ...
                  <a href={urlPublica} target="_blank" className="mt-4 w-full py-4 bg-blue-50 hover:bg-blue-100 text-blue-600 font-black rounded-xl transition-all flex items-center justify-center gap-2">
            ...
            <div className="bg-white p-8 rounded-[40px] border border-slate-200 shadow-xl flex flex-col items-center justify-center text-center">
               ...
               <div className="bg-white p-4 rounded-3xl border-4 border-slate-100 shadow-sm relative group cursor-pointer hover:border-blue-200 transition-colors">
                  {qrCodeUrl ? (
                  ...
                  <div className="absolute inset-0 bg-blue-600/90 text-white rounded-[24px] opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center font-black">
                     <ArrowDown size={32} className="mb-2"/>
                     Clique p/ Salvar
                  </div>
               </div>

               <a href={qrCodeUrl} download="QR_Cardapio.png" target="_blank" className="mt-8 text-blue-600 font-black hover:underline uppercase tracking-widest text-sm">
