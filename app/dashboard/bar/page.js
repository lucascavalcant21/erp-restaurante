    ...
    <div className="min-h-screen font-sans pb-24 text-slate-800">
      ...
      <div className="pt-6 pb-8 px-6 max-w-6xl mx-auto flex items-center gap-4">
         ...
         <div>
            ...
            <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mt-1">Gestão de Bebidas e Produção</p>
         </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6 auto-rows-[140px]">
         ...
         <button onClick={() => router.push("/dashboard/operacao/fichas?dept=bar")} className="col-span-1 lg:col-span-2 row-span-1 rounded-[24px] p-6 bg-white border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all flex flex-col justify-between group">
