  ...
  return (
    <div className="min-h-screen font-sans pb-24 text-slate-800">
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
         ...
         {/* ITEM NOVO: DELIVERY */}
         <button onClick={() => router.push("/dashboard/salao/online")} className="rounded-[32px] p-10 bg-slate-900 hover:bg-slate-800 text-white transition-all shadow-xl shadow-slate-900/20 flex flex-col justify-between group text-left h-64">
         ...
         <button onClick={() => router.push("/dashboard/checklists?dept=salao&tipo=operacional")} className="rounded-[32px] p-10 bg-white border-2 border-slate-200 hover:border-slate-400 transition-all shadow-sm flex flex-col justify-between group text-left h-64">
         ...
         <button onClick={() => router.push("/dashboard/salao/treinamento")} className="rounded-[32px] p-10 bg-white border-2 border-slate-200 hover:border-slate-400 transition-all shadow-sm flex flex-col justify-between group text-left h-64">
            <div className="w-16 h-16 rounded-2xl bg-slate-100 text-slate-800 flex items-center justify-center mb-6">
