      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-6">
         ...
         <button onClick={() => router.push("/dashboard/salao/checklist")} className="rounded-[32px] p-10 bg-white border border-slate-200 hover:border-emerald-300 transition-all shadow-sm flex flex-col justify-between group text-left h-64">
            ...
            <div>
               ...
               <p className="text-slate-500 font-medium">Procedimentos de abertura do salão, conferência de mesas, banheiros e fechamento de caixa.</p>
            </div>
         </button>
         ...
         <button onClick={() => router.push("/dashboard/salao/treinamento")} className="rounded-[32px] p-10 bg-white border border-slate-200 hover:border-emerald-300 transition-all shadow-sm flex flex-col justify-between group text-left h-64">
            ...
            <div>
               ...
               <p className="text-slate-500 font-medium">Manuais de atendimento, scripts de venda sugestiva, postura e regras do restaurante.</p>
            </div>
         </button>
