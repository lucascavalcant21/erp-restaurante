...
export async function gerarDadosFicticios() {
  ...
  try {
    ...
    // 8. Mesas
    const mesasSeed = [
       { unidade_id: uid, numero: "01", numero_mesa: "01", status: "ocupada" },
       { unidade_id: uid, numero: "02", numero_mesa: "02", status: "livre" },
       { unidade_id: uid, numero: "03", numero_mesa: "03", status: "ocupada" },
    ];
