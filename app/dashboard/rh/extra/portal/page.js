          ...
          <>
            ...
            <section className="rounded-2xl border border-line bg-card p-4 shadow-sm sm:p-5">
              ...
              <label className="mt-4 flex items-center gap-2.5">
                ...
                <span className="text-sm font-bold text-fg-soft">Mostrar o endereço do restaurante</span>
              </label>
            </section>
            ...
            <section className="rounded-2xl border border-line bg-card p-4 shadow-sm sm:p-5">
              ...
              <div className="mt-4 space-y-4">
                {config.perguntas.map((p, i) => (
                  <div key={p.id || i} className="rounded-2xl border border-line p-3.5">
                      ...
                      {p.opcoes.map((o, j) => (
                        <div key={j} className="flex items-center gap-2">
                          ...
                          <input value={o} onChange={e => mudarOpcao(i, j, e.target.value)}
                            ...
                            className="h-11 flex-1 rounded-xl border border-line px-3 font-semibold text-fg-soft outline-none focus:border-emerald-600" />
                          {p.opcoes.length > 2 && (
                            <button onClick={() => removerOpcao(i, j)} className="grid h-11 w-11 shrink-0 place-items-center rounded-xl text-subtle hover:text-red-600"><X size={16} /></button>
                          )}
                        </div>
                      ))}
