...
export default function ContratoRhPage() {
  ...
  return (
    <div className="min-h-screen bg-elevated font-sans text-slate-800 pb-20">
      ...
      {/* Papel (A4) */}
      <div className="max-w-[21cm] mx-3 sm:mx-auto bg-card p-4 sm:p-8 lg:p-[2cm] mt-4 sm:mt-8 shadow-2xl print:shadow-none print:m-0 print:p-0">
        ...
        <div className="mb-10 text-sm">
           <p className="mb-2"><strong className="text-fg">Nome do Colaborador:</strong> {colaborador.nome}</p>
           <p className="mb-2"><strong className="text-fg">Cargo / Função:</strong> {colaborador.cargo}</p>
           <p className="mb-2"><strong className="text-fg">Data de Emissão:</strong> {new Date().toLocaleDateString('pt-BR')}</p>
        </div>
