  ...
  return <div className="min-h-screen bg-[var(--surface)] pb-24 text-slate-800">
    <header className="sticky top-0 z-20 border-b border-line bg-white/95 px-4 py-4 backdrop-blur sm:px-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2"><input type="date" value={dataReferencia} onChange={e => setDataReferencia(e.target.value)} className="h-11 rounded-xl border border-line bg-card px-3 font-bold"/><select value={status} onChange={e => setStatus(e.target.value)} className="h-11 rounded-xl border border-line bg-card px-3 font-bold"><option value="rascunho">Rascunho</option><option value="confirmado">Confirmado</option></select><button onClick={salvar} disabled={salvando} className="flex h-11 items-center gap-2 rounded-xl bg-emerald-600 px-4 font-black text-white disabled:opacity-50"><Save size={18}/>{salvando ? "Salvando..." : "Salvar"}</button><button onClick={enviarProducaoWhatsApp} className="flex h-11 items-center gap-2 rounded-xl border-2 border-emerald-200 bg-card px-4 font-black text-emerald-700 hover:bg-emerald-50"><Share2 size={18}/>Produção no WhatsApp</button><button onClick={enviarComprasWhatsApp} className="flex h-11 items-center gap-2 rounded-xl border-2 border-emerald-200 bg-card px-4 font-black text-emerald-700 hover:bg-emerald-50"><Share2 size={18}/>Compras no WhatsApp</button><button onClick={imprimir} className="flex h-11 items-center gap-2 rounded-xl bg-slate-900 px-4 font-black text-white"><Printer size={18}/>Imprimir</button></div>
      </div>
    </header>

    <main className="mx-auto max-w-7xl space-y-5 px-4 py-6 sm:px-6">
      <div className="grid grid-cols-2 gap-2 rounded-2xl bg-slate-200 p-1.5"><button onClick={() => setSetorAtivo("cozinha")} className={`flex min-h-12 items-center justify-center gap-2 rounded-xl font-black ${setorAtivo === "cozinha" ? "bg-emerald-700 text-white shadow" : "text-slate-600"}`}><ChefHat size={19}/>Cozinha</button><button onClick={() => setSetorAtivo("bar")} className={`flex min-h-12 items-center justify-center gap-2 rounded-xl font-black ${setorAtivo === "bar" ? "bg-blue-700 text-white shadow" : "text-slate-600"}`}><GlassWater size={19}/>Bar</button></div>
